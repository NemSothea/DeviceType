...
public struct DeviceType {
    ...
    static public func getVersion(code: String) -> Version {
           switch code {
           /*** iPhone ***/
           //old version
           case "iPhone1,1" :                              return .iPhoneOriginal
           case "iPhone1,2" , "iPhone2,1" :                return .iPhone3G
           ...
           case "iPad8,9", "iPad8,10":                      return .iPadPro11_0Inch4
    ...
    static public func getType(code: String) -> Type {
